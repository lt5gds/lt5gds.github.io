...
var list=['InitialDesign','Game Architecture','SpriteBatch','sound','TestSoundLibgdx','index','highconcept','Rangkuman Dokumentasi Libgdx','test libgdx','OnePageDesignTemplate','StoryBibleTemplate','CTaylorDesign'];
